...
export default function CourseDetail() {
  ...
  const handleNavigateToSearch = (searchType: "course" | "professor", query: string) => {
    ...
    <div className="flex flex-col min-h-screen bg-background max-w-md mx-auto">
      ...
      <main className="flex-1 overflow-y-auto pb-20">
        <div className="px-4 py-4 border-b border-border">
          <CourseHeader course={course} onNavigateToSearch={handleNavigateToSearch} />
          <CourseRatingSummary
        ...
        <ReviewPreviewSection reviews={reviews} onViewAll={() => router.push(`/courses/${courseId}/reviews`)} />
        <ExamPreviewSection examInfos={examInfos} onViewAll={() => router.push(`/courses/${courseId}/exam`)} />
      </main>
