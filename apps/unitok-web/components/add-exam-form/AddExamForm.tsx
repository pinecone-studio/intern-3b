...
export function AddExamForm({ onBack, onSubmit }: { onBack: () => void; onSubmit: () => void }) {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background max-w-md mx-auto">
      ...
      <main className="flex-1 overflow-y-auto pb-24">
        <div className="px-4 py-4 space-y-6">
          ...
          <div className="border-t border-border pt-4">
            <ExamOptionalToggle open={showOptional} onToggle={() => setShowOptional(!showOptional)} />
      ...
      <ExamFormFooter isValid={isValid} showTicketInfo={showTicketInfo} onSubmit={handleSubmit} />
    </div>
  )
}
