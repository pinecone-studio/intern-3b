    ...
    <div className="w-full px-4 py-3 text-left">
      <div className="flex items-center justify-between mb-1">
        ...
        <div className="flex items-center gap-1">
          ...
          <span className="text-sm font-semibold text-star-yellow">{review.rating.toFixed(1)}</span>
        </div>
      </div>
      <p className="text-sm text-foreground leading-snug line-clamp-2 mb-2">{review.text}</p>
