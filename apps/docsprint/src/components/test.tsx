...
// import { Separator } from '../components/ui/separator'; // Separator замыг анхаарна уу
...
//       <DialogContent className="sm:max-w-[720px] bg-white text-zinc-900 border-zinc-200 shadow-xl">
//         <DialogHeader>
...
//         {/* ✅ Step progress line - Цайвар хувилбар */}
//         <div className="mt-2">
...
//                     i <= stepIndex ? 'bg-emerald-500' : 'bg-zinc-100',
//                   ].join(' ')}
//                 />
//               </React.Fragment>
//             ))}
...
//         <Tabs value={step}>
//           <TabsList className="w-full bg-zinc-50 border border-zinc-200 pointer-events-none p-1">
//             <TabsTrigger
//               value="personal"
...
//                       <Label className="text-zinc-700">Овог</Label>
//                       <Input
//                         value={form.lastName}
//                         onChange={setField('lastName')}
//                         placeholder="Овог оруулах"
//                         className="bg-white border-zinc-300 focus:ring-emerald-500"
//                       />
//                     </div>
//                     <div className="space-y-2">
//                       <Label className="text-zinc-700">Нэр</Label>
//                       <Input
...
//                       <Label className="text-zinc-700">Регистрын дугаар</Label>
//                       <Input
//                         value={form.regNo}
...
//                     </div>
//                     <div className="space-y-2 md:col-span-2">
//                       <Label className="text-zinc-700">Гэрийн хаяг</Label>
//                       <Input
//                         value={form.address}
...
//                     </div>
//                     <div className="space-y-2">
//                       <Label className="text-zinc-700">И-мэйл</Label>
//                       <Input
//                         type="email"
//                         value={form.email}
...
//                     </div>
//                     <div className="space-y-2">
//                       <Label className="text-zinc-700">Утас</Label>
//                       <Input
//                         value={form.phone}
...
//                   <div className="grid grid-cols-1 md:grid-cols-2 gap-5 p-1">
//                     <div className="space-y-2">
//                       <Label className="text-zinc-700">Албан тушаал</Label>
//                       <Input
//                         value={form.position}
...
//                     </div>
//                     <div className="space-y-2">
//                       <Label className="text-zinc-700">Хэлтэс</Label>
//                       <Input
...
//                     </div>
//                     <div className="space-y-2 md:col-span-2">
//                       <Label className="text-zinc-700">Ажилд орсон огноо</Label>
//                       <Input
//                         type="date"
...
//                   <div className="grid grid-cols-1 md:grid-cols-2 gap-5 p-1">
//                     <div className="space-y-2">
//                       <Label className="text-zinc-700">Банк</Label>
//                       <Input
//                         value={form.bankName}
...
//                     </div>
//                     <div className="space-y-2">
//                       <Label className="text-zinc-700">Дансны дугаар</Label>
//                       <Input
...
//                     </div>
//                     <div className="space-y-2 md:col-span-2">
//                       <Label className="text-zinc-700">Данс эзэмшигч</Label>
//                       <Input
...
//               disabled={!canGoNext}
//             >
//               {stepIndex < steps.length - 1 ? 'Дараах' : 'Хадгалах'}
//             </Button>
//           </div>
//         </div>
//       </DialogContent>
