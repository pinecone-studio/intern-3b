...
export function Hero() {
  return (
    <section className="relative min-h-screen overflow-hidden bg-[#fcfdfe] pt-32 pb-24 lg:pt-48 lg:pb-32 text-slate-900">
      <div className="absolute inset-0 z-0 bg-[linear-gradient(to_right,#e2e8f0_1px,transparent_1px),linear-gradient(to_bottom,#e2e8f0_1px,transparent_1px)] bg-size-[48px_48px] mask-[radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)] opacity-50" />

      <div className="absolute top-0 left-1/4 w-150 h-150 bg-blue-400/10 blur-[140px] rounded-full pointer-events-none" />
      <div className="absolute bottom-0 right-1/4 w-125 h-125 bg-cyan-300/10 blur-[120px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-blue-100 bg-white/80 backdrop-blur-md mb-8 shadow-sm animate-in fade-in slide-in-from-top-4 duration-700">
            ...
            <span className="text-[10px] text-slate-500 font-black uppercase tracking-[0.2em]">cd ..
              DocSprint v2.0 • AI Powered HR
            </span>
            <ChevronRight className="w-3 h-3 text-slate-300" />
          </div>

          <h1 className=" lg:text-8xl font-black tracking-[-0.04em] leading-none text-[#111827] animate-in fade-in slide-in-from-bottom-6 duration-1000">
            <span className="text-7xl"> Ажилтны удирдлагыг</span> <br />
            <span className="relative inline-block mt-2">
              <span className="relative text-6xl z-10 text-transparent bg-clip-text bg-linear-to-r from-[#005bb7] via-[#0072e5] to-cyan-500">
                автоматжуул
              </span>
