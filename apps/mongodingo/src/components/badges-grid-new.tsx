...
import { Trophy, Flame, Zap, Award, Target, Star, Crown, Medal } from "lucide-react"

const badges = [
  { icon: Trophy, name: "First Lesson", description: "Complete your first lesson", unlocked: true, color: "amber-500" },
  {
    icon: Flame,
    name: "7-Day Streak",
  ...
  { icon: Zap, name: "1000 XP", description: "Earn 1000 total XP", unlocked: true, color: "primary" },
  {
    icon: Award,
    name: "Perfect Score",
  ...
  { icon: Target, name: "Skill Master", description: "Complete an entire skill", unlocked: true, color: "blue-500" },
  {
    icon: Star,
    name: "Fast Learner",
  ...
  { icon: Crown, name: "Top 10", description: "Reach top 10 on leaderboard", unlocked: false, color: "amber-500" },
  { icon: Medal, name: "Marathon", description: "30-day learning streak", unlocked: false, color: "orange-500" },
]
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {badges.map((badge, index) => (
          <motion.div
            ...
            whileHover={{ scale: badge.unlocked ? 1.1 : 1.0, y: badge.unlocked ? -5 : 0 }}
