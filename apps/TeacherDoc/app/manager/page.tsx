...
const grades = [
  ...
  { id: '8', name: '8-р анги' },
  { id: '9', name: '9-р анги' },
  { id: '10', name: '10-р анги' },
  { id: '11', name: '11-р анги' },
  { id: '12', name: '12-р анги' },
];
  ...
  return (
    <div className="flex h-screen bg-[#F8FAFC] overflow-hidden">
      <aside className="w-[280px] bg-white border-r border-gray-100 flex flex-col p-6 h-full overflow-y-auto">
        ...
        <div className="mb-8">
          <h3 className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-4 font-sans">
            Хичээл
          </h3>
        ...
        <div className="mt-auto p-4 bg-emerald-50 rounded-2xl border border-emerald-100">
          <p className="text-[10px] font-bold text-[#00A378] uppercase mb-1">
            Мэдээлэл
          </p>
          <p className="text-xs text-emerald-800 leading-relaxed font-medium">
            Та нийт {modules.length} сэдвийг удирдаж байна.
          </p>
        </div>
      </aside>
      ...
      <main className="flex-1 flex flex-col h-full  overflow-hidden">
        <div className="w-full max-w-[1450px] mx-auto px-10 pt-10">
          <header className="flex justify-between items-start mb-10">
            <div>
              <p className="text-[10px] font-bold text-[#00A378] uppercase tracking-widest mb-1">
                • Систем менежер
              </p>
              ...
              <p className="text-gray-400 text-sm mt-1">
                Хичээлийн бүтэц, дэд сэдвүүдийг нарийвчлан удирдах
              </p>
            </div>
          ...
          <div className="w-full max-w-[1450px] mx-auto space-y-4">
            {loading ? (
              ...
              filteredModules.map((mod) => (
                <div
                  key={mod.id}
                  className="group bg-white rounded-[32px] border border-gray-100 overflow-hidden shadow-sm hover:shadow-md transition-shadow"
                >
                  <div className="flex items-center p-6 relative">
                    ...
                    <div className="flex-1 ml-4">
                      <div className="flex items-center gap-4 mb-2">
                        <span className="bg-emerald-50 text-[#00A378] text-[10px] font-extrabold uppercase px-3 py-1 rounded-full">
                          {subjects.find((s) => s.id === mod.lessonId)?.name ||
                            'Хичээл'}
                        </span>
                        <span className="text-gray-400 text-[11px] font-medium">
                          {grades.find((g) => g.id === mod.gradeId)?.name} •{' '}
                          {terms.find((t) => t.id === mod.semesterId)?.name}
                        </span>
                      </div>
                    ...
                    <div className="flex items-center gap-8 mr-6">
                      ...
                      <button
                        onClick={() =>
                          setSelectedModuleId(
                            selectedModuleId === mod.id ? null : mod.id,
                          )
                        }
                      ...
                      <div className="bg-white rounded-2xl p-6 shadow-inner border border-gray-100">
                        ...
                        <div className="mt-6 space-y-3">
                          {mod.subModules.map((sm, index) => (
                            ...
                            >
                              <span className="w-6 h-6 flex items-center justify-center bg-white rounded-lg text-[10px] font-bold text-emerald-600 shadow-sm">
                                {index + 1}
                              </span>
