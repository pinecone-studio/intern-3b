...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFA]  relative overflow-hidden">
      ...
      <main className="max-w-376 mx-auto px-6 py-10 relative z-10">
        <Navbar
        ...
        <div className="mb-16 mt-10 text-center animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <h1 className="mb-6 text-4xl md:text-6xl font-extrabold tracking-tight text-[#1A1A1A]">
            ...
            <span className="bg-linear-to-r via-[#10B981] to-[#F97316] bg-clip-text  from-primary text-transparent px-2">
              хялбар
            </span>
            хуваалцаарай
          </h1>
          <p className="mx-auto max-w-2xl text-pretty text-muted-foreground md:text-lg">
            Монголын багш нарт зориулсан хичээлийн материал хуваалцах, хайх,
            ашиглах боломжтой нэгдсэн платформ
          </p>
        </div>

        <Card className="border-none shadow-2xl shadow-emerald-900/5 rounded-4xl overflow-hidden bg-white mb-12">
          <CardContent className="p-10">
            <div className="flex items-center gap-4 mb-10">
              ...
              <div>
                ...
                <p className="text-sm text-[#888]">
                  Дараалалд нь сонголтоо хийнэ үү
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  <span className="flex size-7 items-center justify-center rounded-full bg-slate-200 text-slate-500 text-xs font-bold">
                    2
                  </span>
                  <label className="text-sm font-bold text-[#444]">
                    Анги сонгоно
        ...
        {isProgressComplete && !selectedTopicId && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 animate-in fade-in duration-500">
            {isLoading ? (
              <p className="col-span-full text-center py-20 text-emerald-600 font-bold">
                Ачааллаж байна...
              </p>
            ) : (
              modules.map((mod) => (
          ...
          <div className="mt-10 animate-in slide-in-from-right-8 duration-500 max-w-full">
            ...
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500 font-medium">
                  {selectedTopic.subModules.length} хичээл
                </p>
              </div>
            </div>
            ...
            <div className="grid  gap-5">
              {selectedTopic.subModules.map((sub, idx) => (
                <div
                  key={sub.id}
                  className="relative bg-white border border-slate-100 rounded-3xl p-10 shadow-sm hover:shadow-md transition-all overflow-hidden group"
                >
                  <div className="absolute left-0 top-0 bottom-0 w-1.5 bg-linear-to-b from-emerald-500 to-orange-400" />
                  ...
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div className="flex items-center gap-6">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <div className="flex items-center gap-2 text-slate-400 text-sm font-medium">
                          ...
                          <span>
                            {Math.floor(Math.random() * 5) + 1} багш материал
                            бэлтгэсэн
                          </span>
                        </div>
                      </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      bg-[#059669] rounded-xl text-sm font-bold text-white
                      hover:bg-emerald-700 transition-all shadow-sm
                      shadow-emerald-200"
                        href={`/sub-module/${sub.id}?moduleId=${selectedTopic.id}&name=${encodeURIComponent(sub.name)}`}
                      >
                        Дэлгэрэнгүй
                      </Link>
                    </div>
...
function FeatureCard({
  ...
  return (
    <Card
      className={`border-none rounded-[32px] p-4 ${styles[color]} shadow-sm`}
    >
      <CardContent className="p-6">
        <div
          className={`size-14 rounded-2xl bg-white shadow-sm flex items-center justify-center mb-6`}
        >
